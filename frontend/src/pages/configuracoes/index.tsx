  ...
  return (
    <>
      <PageHeader
        kicker="Retaguarda"
        title="Configurações"
        subtitle="Perfil no WhatsApp, horário, preparo, montagem por categoria, cupom, impressão, tempo sem resposta e taxas de entrega."
      />
      ...
      <div className="flex flex-col gap-6">
        ...
        <BatchCategorySettingsCard store={store} />
